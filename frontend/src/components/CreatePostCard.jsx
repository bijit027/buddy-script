...
import styles from '../../public/assets/css/CreatePostCard.module.css';
      ...
      <form onSubmit={handleSubmit}>
        <div className="_feed_inner_text_area_box">
          ...
          <div className="form-floating _feed_inner_text_area_box_form ">
            <textarea
              className={`form-control _textarea ${styles.textarea} ${content.length > 100 ? styles.expanded : ''}`}
        ...
        <div className={`_feed_inner_text_area_bottom ${styles.bottomBar}`}>
          ...
          <div className={`_feed_inner_text_area_btn ${styles.actionsRow}`}>
            ...
            >
              {isLoading ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" fill="none" viewBox="0 0 14 13" aria-hidden="true">
