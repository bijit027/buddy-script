import styles from '../../public/assets/css/LeftSidebar.module.css';
          ...
          <ul className="_left_inner_area_explore_list">
            {NAV_LINKS.map(({ icon, label }) => (
              <li key={label} className="_left_inner_area_explore_item">
                <a href="#0" className={`_left_inner_area_explore_link ${styles.exploreLink}`}>
                  <span className={styles.exploreIcon}>{icon}</span> {label}
                </a>
              </li>
            ))}
          </ul>
