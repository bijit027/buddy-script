        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="_header_nav_profile">
            <div className="_header_nav_profile_image">
              <img src={user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'U')}&background=4f46e5&color=fff`} alt="Image" className="_nav_profile_img" />
            </div>
            ...
            {showProfileDrop && (
              <div className="_nav_profile_dropdown _profile_dropdown" style={{ display: 'block', position: 'absolute', right: 0, top: '100%', zIndex: 1000 }}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <img src={user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || 'U')}&background=4f46e5&color=fff`} alt="Image" className="_nav_drop_img" />
                  </div>
                ...
                <ul className="_nav_dropdown_list">
                  <li className="_nav_dropdown_list_item">
                    <a href="#0" onClick={(e) => { e.preventDefault(); handleLogout(); }} className="_nav_dropdown_link">
